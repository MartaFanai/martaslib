...
class SyncController extends Controller
{
    ...
    public function downloadCsv()
    {
        ...
        foreach ($books as $book) {
            fputcsv($file, [$book->id, $book->bookid, $book->title, $book->author->name, $book->edition, $book->year, $book->publisher->name, $book->pages, $book->accessionno, $book->classificationno, $book->subject, $book->bookno, $book->description, $book->price, $book->location, $book->qty, $book->member_id, $book->issuer, $book->del, date('d-m-Y', strtotime($book->created_at)), date('d-m-Y', strtotime($book->updated_at))]);
        }
