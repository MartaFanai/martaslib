        ...
        <div class="card-header bg-primary"><h5>Lehkhabu thar dahluhna</h5></div>
          <div class="card-body text-dark">
            <form method="post" action="{{ route('books.store') }}">
              ...
              <!-- <div class="form-group">
                  <label>Classification No <span class="text-danger"> *</span></label>
                  <input type="text" class="form-control" name="classification" placeholder="Classification No" value="{{ old('classification') }}" required>
                  <div class="clearfix"></div>
              </div> -->
              ...
              <!-- <div class="form-group">
                  <label>Book No</label>
                  <input type="text" class="form-control" name="bookno" placeholder="Book No" value="{{ old('bookno') }}" required>
                  <div class="clearfix"></div>
              </div> --> 
