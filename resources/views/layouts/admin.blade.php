    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview @if($segment == 'issue' || $segment == 'return' || $segment == 'retBybook' || $segment == 'receipt' || $segment == 'report' || $segment == 'code' || $segment == 'retreport')
                                                    menu-open
                                                  @endif">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="wrap">
          ...
          <div class="cont">
            <p class="info">This Library Software is specially designed for Ramthar Veng Presbyterian Kohhran in the year 2024 for maintaining and digitalized its existing transaction.</p>
...
<style type="text/css">
  ...
  <footer id="printPageButton" class="main-footer">
    <strong>Copyright &copy; 2024 @if(2024 < $cur_year ) - {{ Carbon\Carbon::now()->format('Y') }} @endif &nbsp; &nbsp; Ramthar Veng Presbyterian Kohhran</strong>
    &nbsp; &nbsp;All rights reserved
